+++
title = "Is German Train Travel Faster North↔South or East↔West?"
date = 2025-12-26
...
2. Create all pairs of cities that traverse a North↔South or East↔West boundary.
...
5. Group routes into North↔South or East↔West and plot a distribution.
...
* Prepare:
    1. Take the area of Germany and subdivide it into areas using H3 or A5.
    2. Use the centroid of each of these to categorise into quadrants.
    3. Find all pairs as before, but this time between centroids of areas.
...
One thing I *will* probably do sooner is re-use the [motis server setup](https://github.com/motis-project/motis). It was a massive pain trying out various public/private libraries/services for travel times, and finding various versions of broken-ness or "please talk to sales" road-blocks.
