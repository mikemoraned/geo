...
{{ image(src="/images/les-villes-rangees-website-2024.png") }}
...
<div class="columns">
    ...
    <div class="column">
        <div class="card">
            ...
            <div class="card-image">
                {{ image(src='/images/garibaldi.png') }}
            </div>
            <div class="card-content">
                <div class="content is-size-5">
                    <ul>
...
<div class="columns">
    <div class="column">
        <div class="card">
            ...
            <div class="card-image">
                {{ image(src='/images/boundaries.png') }}
            </div>
            <div class="card-content">
...
However, the pixel-level version I have works for now. As long as I wrap it behind a <code>trait</code> I can replace it later.
    ...
    <div class="column">
        <div class="card">
            ...
            <div class="card-image">
                {{ image(src='/images/edinburgh_layout_pedestrian.1000.guillotine.rotated.png') }}
            </div>
            <div class="card-content">
                <div class="content is-size-6">
