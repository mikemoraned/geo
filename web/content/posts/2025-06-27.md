...
{{ image(src='/images/amsterdam_without_water.draw.png') }}
...
{{ image(src='/images/amsterdam_bounds_masked.png') }}
* 4: Draw the water areas as border pixels: {{ image(src='/images/amsterdam_with_water.draw.png') }}
