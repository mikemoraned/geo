...
export const create_source: (a: number, b: number, c: number, d: number) => any;
export const annotate: (a: number) => any;
...
export const annotatedjs_centroid: (a: number) => any;
...
export const annotatedjs_most_similar_ids: (a: number, b: number, c: number) => any;
export const annotatedjs_most_similar_regions: (a: number, b: number, c: number) => [number, number];
