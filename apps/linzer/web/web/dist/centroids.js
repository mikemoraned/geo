...
export class AnnotatedJS {
     ...
     * @returns {any}
     */
    centroids_geojson_string() {
        const ret = wasm.annotatedjs_centroids_geojson_string(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {any}
     */
    regions_geojson_string() {
        const ret = wasm.annotatedjs_regions_geojson_string(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {any}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('centroids_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
