...
- [ ] Merge `origin/main`, taking the union on the five textual conflicts: `Cargo.toml`
...
- [ ] Rename this branch's crate to `session_crossings`, so the three add/add collisions
