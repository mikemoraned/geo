//! Spike 3's behaviour: accumulate NMEA sentences into a position fix and render it
//! alongside the clock. Parsing lives here rather than in the shell so it can be tested
//! against recorded sentences on the laptop — the GPS needs sky view and a ~23s cold
