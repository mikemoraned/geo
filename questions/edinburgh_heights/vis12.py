...
def _():
    ...
    return BoundaryNorm, cx, gpd, griddata, mo, np, plt, vectorized
...
def _(cx, grid, maxx, maxy, minx, miny, plt):
    ...
    ax1.imshow(grid, extent=[minx, maxx, miny, maxy], origin="lower", cmap="terrain")
    cx.add_basemap(
